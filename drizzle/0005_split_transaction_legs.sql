CREATE TABLE "transaction_leg" (
	...
	CONSTRAINT "transaction_leg_posting_target_unique" UNIQUE("user_id","transaction_id","id"),
...
ALTER TABLE "posting" ADD CONSTRAINT "posting_leg_owner_fk" FOREIGN KEY ("user_id","transaction_id","leg_id") REFERENCES "public"."transaction_leg"("user_id","transaction_id","id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint

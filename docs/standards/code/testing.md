...
| | Files | Tests |
| --- | --- | --- |
| `npm test`, no database | 138 pass, 61 skip | **1,421 pass, 700 skip** |
| `npm test`, database set | 199 pass | **2,121 pass** |
...
1,421 rather than among the skips, which is why the two rows add up to 2,121
both times.

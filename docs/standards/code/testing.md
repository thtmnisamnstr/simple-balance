...
| | Files | Tests |
| --- | --- | --- |
| `npm test`, no database | 138 pass, 63 skip | **1,433 pass, 705 skip** |
| `npm test`, database set | 201 pass | **2,138 pass** |
...
1,433 rather than among the skips, which is why the two rows add up to 2,138
both times.

...
| | Files | Tests |
| --- | --- | --- |
| `npm test`, no database | 138 pass, 63 skip | **1,422 pass, 705 skip** |
| `npm test`, database set | 201 pass | **2,127 pass** |
...
1,422 rather than among the skips, which is why the two rows add up to 2,127
both times.

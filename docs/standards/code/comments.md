...
**19.5% of the non-blank lines in `src` are comments** — 9,133 of 46,909. That
...
`9,133 of 46,909` against the recount exactly.
...
That one is `src/client/forms.tsx:534`. `src/client/components.tsx:498`

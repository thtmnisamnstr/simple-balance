...
**19.6% of the non-blank lines in `src` are comments** — 9,261 of 47,186. That
...
`9,261 of 47,186` against the recount exactly.
...
That one is `src/client/forms.tsx:534`. `src/client/components.tsx:639`
...
directly above the disable. The exception is `src/client/forms.tsx:1651`, where

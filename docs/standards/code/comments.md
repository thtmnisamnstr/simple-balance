...
**18.3% of the non-blank lines in `src` are comments** — 8,328 of 45,207. That
...
`8,328 of 45,207` against the recount exactly.
...
That one is `src/client/forms.tsx:534`. `src/client/components.tsx:497`
...
directly above the disable. The exception is `src/client/forms.tsx:1638`, where

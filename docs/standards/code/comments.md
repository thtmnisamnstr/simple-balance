...
**18.3% of the non-blank lines in `src` are comments** — 8,182 of 44,670. That
...
`8,182 of 44,670` against the recount exactly.
...
That one is src/client/forms.tsx:506`. `src/client/components.tsx:497`
...
directly above the disable. The exception is src/client/forms.tsx:1594`, where

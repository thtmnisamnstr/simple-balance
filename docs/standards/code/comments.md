...
**18.3% of the non-blank lines in `src` are comments** — 8,298 of 45,134. That
...
`8,298 of 45,134` against the recount exactly.
...
That one is src/client/forms.tsx:536`. `src/client/components.tsx:497`
...
directly above the disable. The exception is src/client/forms.tsx:1640`, where

...
- **The invariant with the consequence of breaking it.**
  src/shared/domain.ts:2139-2146`: "`.strict()` is the load-bearing part: a
...
| --- | --- |
| Every MCP tool name appears in `docs/mcp.md` | tests/mcp-parity.test.ts:299-304`, by name rather than by count, "so the failure says which" |
